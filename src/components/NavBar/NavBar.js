            ...
            <div className="navbar">
                <div className="navbar__under">
                    <div className="navbar__under-drop">
                        ...
                        <div className={`navbar__name ${visible ? "navbar__visible" : "navbar__hidden"}`} onClick={() => setIsOpen(false)}>
                ...
                <ul className="navbar__list">
                    ...
                    <li className="navbar__list-item"><a href="https://github.com/brentahrens1" target="_blank" rel="noopener noreferrer">Github</a></li>
                </ul>
